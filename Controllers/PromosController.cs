...
namespace TallerMVC2JuanJoseAraujo.Controllers
{
    public class PromosController : Controller
    {
        ...
        public PromosController(TallerMVC2JuanJoseAraujoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Promo != null ? 
                          ...
                          Problem("Entity set 'TallerMVC2JuanJoseAraujoContext.Promo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TallerMVC2JuanJoseAraujoContext.Promo'  is null.");
            }
            var promo = await _context.Promo.FindAsync(id);
            if (promo != null)
            {
