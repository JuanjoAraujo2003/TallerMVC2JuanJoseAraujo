...
namespace TallerMVC2JuanJoseAraujo.Controllers
{
    public class BurgersController : Controller
    {
        private readonly TallerMVC2JuanJoseAraujoContext _context;

        public BurgersController(TallerMVC2JuanJoseAraujoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'TallerMVC2JuanJoseAraujoContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TallerMVC2JuanJoseAraujoContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
